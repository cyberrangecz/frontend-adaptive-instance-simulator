    ...
    return {
        instances: {
            trainingDefinitionDTO: {
                "id": 52,
                "description": "The demo contains all types of phases to demonstrate the capabilities of the CyberRangeᶜᶻ Platform in adaptive training.",
                ...
                "phases": [{
                    ...
                    "tasks": [{
                        ...
                        "title": "Set up SSH access",
                        "order": 0,
                        "content": "For accessing KYPO virtual machines using your local command-line tool, click on `Get SSH access` button to download ZIP file and then follow the instructions in the [documentation](https://docs.platform.cyberrange.cz/user-guide-advanced/sandboxes/sandbox-access/#user-access). When you are ready to advance to the next phase-edit, submit the answer provided by the organizer or click on `Solution` button. ",
                        "answer": "startgame",
                        "solution": "startgame",
            ...
            "training_definition": {
                ...
                "phases": [{
                    ...
                    "tasks": [{
                        ...
                        "order": 0,
                        "global_order": null,
                        "content": "For accessing KYPO virtual machines using your local command-line tool, click on `Get SSH access` button to download ZIP file and then follow the instructions in the [documentation](https://docs.platform.cyberrange.cz/user-guide-advanced/sandboxes/sandbox-access/#user-access). When you are ready to advance to the next phase, submit the flag `startgame`.\n\nClick the \n\n## Flag: startgame",
                        "answer": "Secret flag",
                        "solution": "startgame",
                        "incorrect_answer_limit": 100,
                        "modify_sandbox": false,
                    ...
                    "tasks": [{
                        ...
                        "order": 0,
                        "global_order": null,
                        "content": "The level provides you the time to configure SSH access to the sandbox machines locally. If you rather use the Spice console, skip the level by submitting the flag. \n\nClick the `Get SSH access` button to download ZIP file and then follow the instructions in the [documentation](https://docs.platform.cyberrange.cz/user-guide-advanced/sandboxes/sandbox-access/#user-access). When you are ready to advance to the next phase, submit the flag\n\n## Flag: startgame",
                        "answer": "wordlist.txt",
